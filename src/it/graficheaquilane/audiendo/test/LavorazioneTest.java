...
public class LavorazioneTest {
	...
	public LavorazioneTest(int debug) throws IOException{
		...
		if(contatoreFileZip!=0){
	    	...
	    	String destinazioneLocale = "\\\\192.168.1.8\\afp\\MARAN_IFIS\\" + nomeFilePdfFinale;
			...
			//Lancio PrintNet
			ComandoDOS servicePnet = new ComandoDOS("TEST_PNET.bat");
			//./src/it/graficheaquilane/audiendo/fileBatch/
			...
			if(resultExec) {
				...
				Email e = new Email("ced@nuovaipa.com", "cesidio.aureli@nuovaipa.com", "Nuovo file elaborato da GraficheAquilane", corpoEmail);
				e.sendMail();
